...
import "./BloccCovidDeuxiemeCons.css";
import TxtCovidDeuxiemeCons from "@components/textApp/TxtCovidDeuxiemeCons";


function BloccCovidDeuxiemeCons(props) {
  useEffect(() => {
 ...
 const [currentClassCard, setCurrentClassCard] =useState(classBaseCard);
  ...
  const [ currentRep, setCurrentRep] =useState({
    ...
    const [txtCovid, setTxtCovid] = useState(TxtCovidDeuxiemeCons);
