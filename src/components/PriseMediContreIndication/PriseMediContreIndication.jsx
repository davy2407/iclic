...
function PriseMediContreindication(props) {
  ...
  const Mifepristone = () => {
    return (
      <div>
        <p>
          Insuffisance surrénale chronique, hypersensibilité à la substance
          active ou l’un des excipients, asthme sévère (non contrôlé par le
          traitement), porphyrie héréditaire + grossesse non confirmée par
          échographie ou par tests biologiques, grossesse de plus de 63 jours
          d’aménorrhée, suspicion de grossesse extra-utérine.
        </p>
      </div>
    );
  };
  ...
  const Misoprostol = () => {
    return (
      <div>
        <p>
          hypersensibilité au misoprostol, ou à d’autres prostaglandines ou à
          l’un des excipients, grossesse non confirmée par échographie ou par
          tests biologiques, suspicion de grossesse extra-utérine.
        </p>
      </div>
    );
  };
