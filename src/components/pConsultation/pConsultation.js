...
function PConsultation(props) {
  ...
  const [logoAffiche, setLogoAffiche] = useState(LightOff);

  const [logoNonAffiche, setLogoNonAffiche] = useState(LightOn);
  ...
  return (
    <div className="consultationContainer">
      ...
      >
        ...
        <input type="date" name="DDR" id="DDR"></input>
        <br></br>
        <label for="incertaine">Cocher si date incertaine </label>
        <input type="radio" name="incertaine" id="incertaine"></input>
        ...
        <p>
          ...
          entre parenthèse et en rouge pour prescription échographie de datation
          à l’étape d’après 2/Avec ? : Faire apparaitre « La DDR étant
          incertaine, il est nécessaire de s’assurer de la datation exacte
          rapidement afin de ne pas dépasser le terme légal pour une
          interruption de grossesse par voie médicamenteuse. »
        </p>
        <br></br>
        <h2>Prescription échographie de datation</h2>
        <p>
          1/ ?  « En pratique sur une grossesse a priori toute débutante,
          attendre le résultat des ß-HCG (dans la journée ou le lendemain) pour
          programmer l’échographie (œuf visualisé si ß-HCG 1000-1500 UI/L) afin
          qu’elle ne soit pas répétée inutilement. Il existe la possibilité
          d’attendre la 2ème consultation préalable à l’IVG afin de programmer
          l’échographie de datation en fonction du résultat sanguin. »
        </p>
        ...
        <p>
          + ? : « Faire apparaître la mention « échographie de datation à
          réaliser en urgence pour IVG » sur votre ordonnance afin que le
          forfait IVG soit appliqué, (Index pour radiologue IPE). »
        </p>
        <br></br>
        ...
        <label>
          ...
          <select
            defaultValue={valueDecouverteGro}
            id="decouverteGro"
        ...
        <input type="radio" nom="rchISTOui" id="rchISTOui"></input>
        <br></br>
        <label for="rchISTNon"> NON </label>
        <input type="radio" nom="rchISTNon" id="rchISTNon"></input>
        <br></br>
        <input
          onClick={changementCouleurSVG}
          className="Lampe"
          type="image"
          src={logoAffiche}
        />
        ...
        <input type="radio" nom="dossierIVGOui" id="dossierIVGOui"></input>
        <br></br>
        <label for="dossierIVGNon"> NON </label>
        <input type="radio" nom="dossierIVGNon" id="dossierIVGNon"></input>
        <br></br>
        ...
        <input type="radio" nom="consultationOui" id="consultationOui"></input>
        <br></br>
        <label for="consultationNon"> NON </label>
        <input type="radio" nom="consultationNon" id="consultationNon"></input>
        <br></br>
        <p>
          ontexte biopsychosocial favorable : si réponse « non » précédemment 
          faire apparaître « consultation psychosociale proposée » en rouge.
          {/* Bloc a finir */}
        </p>
        <br></br>
        <p>
          ? : « Elle n’est pas obligatoire pour les personnes majeures. Il
          existe l’obligation légale de le proposer. La patiente a un délai de
          48h de réflexion avant de signer le consentement après cette
          consultation.
        ...
        <input type="radio" nom="infoContraOui" id="infoContraOui"></input>
        <br></br>
        <label for="infoContraNon"> NON </label>
        <input type="radio" nom="infoContraNon" id="infoContraNon"></input>
        <br></br>
        <p>
          ? : « Il est nécessaire d’aborder dès cette consultation, les
          différentes modalités contraceptives. Site possible d’information à
          transmettre à la patiente : Lien{" "}
        ...
        <input type="radio" nom="frottiOui" id="frottiOui"></input>
        <br></br>
        <label for="frottiNon"> NON </label>
        <input type="radio" nom="frottiNon" id="frottiNon"></input>
        <br></br>
        <label for="nonConcerNon"> NON CONCERNEE </label>
        <input type="radio" nom="nonConcerNon" id="nonConcerNon"></input>
        <br></br>
        ...
        <input type="radio" nom="tabacOui" id="tabacOui"></input>
        <br></br>
        <label for="tabacNon"> NON </label>
        <input type="radio" nom="tabacNon" id="tabacNon"></input>
        <br></br>
